...
const mongoose = require('mongoose')    // Usado para ObjectId
...
module.exports = (request, response) => {
    ...
    // Busca un juego que no este completado y que uno de los ids de jugadores coincida con el usuario logueado
    gameModel
        .find({
            $and: [
                {
